...
CREATE TABLE IF NOT EXISTS `song` (
    ...
    introduction VARCHAR(512) DEFAULT NULL,
    singer VARCHAR(128) DEFAULT NULL COMMENT 'singer name (redundant)',
    singer_user_id INT DEFAULT NULL COMMENT 'singer user id (NULL=external)',
    singer_id INT DEFAULT NULL COMMENT 'singer table id (legacy)',
